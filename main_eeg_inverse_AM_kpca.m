...
inverse.type_cov = 'lineal';%'rbf'; %Loreta
inverse.type_eig = 'kpca';%'rbf'; %Loreta
inverse.sig = 0.1;
%inverse.type_cov_alpha = 1.01;
sig = median(pdist(y'));
[Jk,CAYk] = spm_eeg_invert_red_kpca(y,M,QG,vert,face,inverse);
